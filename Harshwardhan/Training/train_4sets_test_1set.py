...
# ──────────────────────────────────────────────────────────────
# 0.  Global config ––––––––––––––––––––––––––––––––––––––––––––
EMBEDDING_DIMS_TO_TEST = [8, 16, 32, 64, 2, 4]
MARGIN           = 1.0
BASE_LR          = 1e-3      
BATCH_SIZE       = 64
EPOCHS           = 100
...
def main():
    ...
    df1 = pd.read_excel('dataset/set1.xls')[COLUMNS]
    df2 = pd.read_excel('dataset/set2.xls')[COLUMNS]
    df3 = pd.read_excel('dataset/set3.xlsx')[COLUMNS]
    df5 = pd.read_excel('dataset/set5.xlsx')[COLUMNS]
    df6 = pd.read_excel('dataset/set6.xlsx')[COLUMNS]
